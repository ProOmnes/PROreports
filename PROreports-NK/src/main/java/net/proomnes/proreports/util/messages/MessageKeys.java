...
public enum MessageKeys {
    ...
    UI_CREATE_REPORT_TITLE("ui.create.report.title", "§7» §8Create new report", false),
    UI_CREATE_REPORT_SELECT_PLAYER("ui.create.report.select.player", "> Select a player... <", false),
    UI_CREATE_REPORT_SELECT_PLAYER_INFO("ui.create.report.select.player", "§8» §7Select a player who is currently online.", false),
    UI_CREATE_REPORT_TARGET_INFO("ui.create.report.target", "§8» §7Specify a player to be reported. §6If you already selected a player, this field can be ignored.", false),
    ...
    UI_REPORT_MANAGEMENT_TITLE("ui.report.management.title", "§7» §8Report Management", false),
    ...
    UI_REPORT_MANAGEMENT_PENDING_TITLE("ui.report.management.pending.title", "§7» §8Pending reports", false),
    ...
    UI_REPORT_MANAGEMENT_PENDING_REPORT("ui.report.management.pending.report", "§8» §f{0} §7| §e{1}\n§f{3}", false),

    UI_REPORT_MANAGEMENT_MODERATOR_TITLE("ui.report.management.moderator.title", "§7» §8My managed reports", false),
    ...
    UI_REPORT_MANAGEMENT_MODERATOR_REPORT("ui.report.management.moderator.report", "§8» §f{0} §7| §e{1}\n§f{3}", false),

    UI_REPORT_MANAGEMENT_SEARCH_TITLE("ui.report.management.search.title", "§7» §8Look up for reports", false),
    UI_REPORT_MANAGEMENT_SEARCH_SELECT_PROGRESS("ui.report.management.search.select.progress", "§8» §7Please select a status.", false),
    UI_REPORT_MANAGEMENT_SEARCH_SELECT_TYPE("ui.report.management.search.select.type", "§8» §7Please select a search type.", false),
    ...
    UI_REPORT_MANAGEMENT_SEARCH_RESULT_TITLE("ui.report.management.search.result.title", "§7» §8Results", false),
    ...
    UI_REPORT_MANAGEMENT_SEARCH_RESULT_REPORT("ui.report.management.search.result.report", "§8» §f{0} §7| §e{1}\n§f{3}", false),

    UI_REPORT_TITLE("ui.report.title", "§7» §8Report {0}", false),
    ...
    UI_MY_REPORTS_TITLE("ui.myreports.title", "§7» §8My reports", false),
    UI_MY_REPORTS_INFO("ui.myreports.info", "§8» §7Please select a report status.", false),

    UI_MY_REPORTS_RESULT_TITLE("ui.myreports.result.title", "§7» §8Results", false),
    ...
    UI_MY_REPORTS_RESULT_REPORT("ui.myreports.result.report", "§8» §f{0} §7| §e{1}\n§f{3}", false),
